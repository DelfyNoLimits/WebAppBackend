<template>
    ...
    <div>
        <div v-for="product in productsSolidDisk" :key="product.id" class="product-container">
...
export default {
    ...
    created() {
        fetch("http://nicolasharo-001-site1.btempurl.com/api/soliddisk")
            .then((response) => response.json())
            .then((data) => {
                this.productsSolidDisk = data;
            });
    },
};
</script>
